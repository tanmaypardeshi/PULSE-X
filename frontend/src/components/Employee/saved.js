...
import Routes from './SavedDetails/routes'
...
function Saved(props) {
    ...
    const handleAmazon = () => {
        history.push('/employee/saved/amazon')
    }

    const handleTwitter = () => {
        history.push('/employee/saved/twitter')
    }
                ...
                <List component="nav" className={classes.list}>
                    <Tooltip title='Twitter' placement='right'>
                        <ListItem button onClick={handleTwitter}>
                            <ListItemIcon>
                                {
                                    location.pathname === '/employee/saved/twitter' ?
                    ...
                    <Tooltip title='Amazon' placement='right'>
                        <ListItem button onClick={handleAmazon}>
                            <ListItemIcon>
                                {
                                    location.pathname === '/employee/saved/amazon' ?
