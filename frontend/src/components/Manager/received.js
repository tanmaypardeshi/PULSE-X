...
function Received(props) {
    ...
    const handleAmazon = () => {
        history.push('/manager/received/amazon')
    }

    const handleTwitter = () => {
        history.push('/manager/received/twitter')
    }
                ...
                <List component="nav" className={classes.list}>
                    <Tooltip title='Twitter' placement='right'>
                        <ListItem button onClick={handleTwitter}>
                            <ListItemIcon>
                                {
                                    location.pathname === '/manager/received/twitter' ?
                    ...
                    <Tooltip title='Amazon' placement='right'>
                        <ListItem button onClick={handleAmazon}>
                            <ListItemIcon>
                                {
                                    location.pathname === '/manager/received/amazon' ?
